...
const dev_mode = false; // Overridden by build_prod script
...
var _ensoft$entrance$EnTrance_Internal$dropPrefix = 'DROP: bad id (expecting ';
var _ensoft$entrance$EnTrance_Internal$errorIsWarning = _elm_lang$core$String$startsWith(
	...
	function (_p0, params) {
		...
		return A2(
			...
			A2(
				...
				0,
				_elm_lang$core$Json_Encode$object(allParams)));
	});
var _ensoft$entrance$EnTrance_Endpoint$addValue = F3(
	function (key, value, otherParams) {
		return {
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: key, _1: value},
			_1: otherParams
...
var _ensoft$entrance$EnTrance_Endpoint$addBool = F2(
	function (key, value) {
		return A2(
			_ensoft$entrance$EnTrance_Endpoint$addValue,
			key,
			_elm_lang$core$Json_Encode$bool(value));
	});
var _ensoft$entrance$EnTrance_Endpoint$addString = F2(
	function (key, value) {
		return A2(
			_ensoft$entrance$EnTrance_Endpoint$addValue,
			key,
...
var _ensoft$entrance$EnTrance_Endpoint$forceRestart = function (endpoint) {
	return A2(
		_ensoft$entrance$EnTrance_Endpoint$sendRaw,
		endpoint,
...
var _ensoft$entrance$EnTrance_Endpoint$isLoading = function (rpcData) {
	var _p7 = rpcData;
	if (_p7.ctor === 'Loading') {
		return true;
	} else {
...
var _ensoft$entrance$EnTrance_Endpoint$Failure = function (a) {
	return {ctor: 'Failure', _0: a};
};
var _ensoft$entrance$EnTrance_Endpoint$Success = function (a) {
	return {ctor: 'Success', _0: a};
};
var _ensoft$entrance$EnTrance_Endpoint$checkId = F3(
	function (expectedId, decoder, decodedId) {
		return (!_elm_lang$core$Native_Utils.eq(decodedId, expectedId)) ? _elm_lang$core$Json_Decode$fail(
			A2(
				_elm_lang$core$Basics_ops['++'],
				_ensoft$entrance$EnTrance_Internal$dropPrefix,
				A2(
					_elm_lang$core$Basics_ops['++'],
					expectedId,
					A2(
						_elm_lang$core$Basics_ops['++'],
						' but received ',
						A2(_elm_lang$core$Basics_ops['++'], decodedId, ')'))))) : _elm_lang$core$Json_Decode$oneOf(
			{
				ctor: '::',
				_0: A2(
					_elm_lang$core$Json_Decode$map,
					_ensoft$entrance$EnTrance_Endpoint$Success,
					A2(_elm_lang$core$Json_Decode$field, 'result', decoder)),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$core$Json_Decode$map,
						_ensoft$entrance$EnTrance_Endpoint$Failure,
						A2(_elm_lang$core$Json_Decode$field, 'error', _elm_lang$core$Json_Decode$string)),
					_1: {ctor: '[]'}
				}
			});
	});
var _ensoft$entrance$EnTrance_Endpoint$decodeRpc = F2(
	function (decoder, rpcData) {
		var _p8 = rpcData;
		if (_p8.ctor === 'Loading') {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_ensoft$entrance$EnTrance_Endpoint$checkId, _p8._0, decoder),
			...
			return _elm_lang$core$Json_Decode$fail(
				A2(
					...
					A2(
						...
						A2(
							_elm_lang$core$Basics_ops['++'],
							_elm_lang$core$Basics$toString(rpcData),
							' (not Loading)'))));
		}
	});
var _ensoft$entrance$EnTrance_Endpoint$Loading = function (a) {
	return {ctor: 'Loading', _0: a};
};
var _ensoft$entrance$EnTrance_Endpoint$loading = function (model) {
	return _ensoft$entrance$EnTrance_Endpoint$Loading(
		_ensoft$entrance$EnTrance_Endpoint$id2string(model.endpoint));
};
var _ensoft$entrance$EnTrance_Endpoint$NotAsked = {ctor: 'NotAsked'};
var _ensoft$entrance$EnTrance_Endpoint$Endpoint = function (a) {
	return {ctor: 'Endpoint', _0: a};
};
var _ensoft$entrance$EnTrance_Endpoint$named = F2(
	function (endpoint, websocket) {
		return _ensoft$entrance$EnTrance_Endpoint$Endpoint(
			{endpoint: endpoint, websocket: websocket, id: 0});
	});
var _ensoft$entrance$EnTrance_Endpoint$default = _ensoft$entrance$EnTrance_Endpoint$named(_ensoft$entrance$EnTrance_Endpoint$defaultEndpoint);
var _ensoft$entrance$EnTrance_Endpoint$send = F2(
	function (model, params) {
		var incr = function (_p9) {
			var _p10 = _p9;
			var _p11 = _p10._0;
			return _ensoft$entrance$EnTrance_Endpoint$Endpoint(
		...
		return {
			...
			_0: _elm_lang$core$Native_Utils.update(
				model,
				{
					endpoint: incr(model.endpoint)
				}),
			_1: A2(_ensoft$entrance$EnTrance_Endpoint$sendRaw, model.endpoint, allParams)
		};
	});
...
var _ensoft$entrance$EnTrance_Notification$Config = F2(
	function (a, b) {
		return {makeGlobal: a, endpoints: b};
	});
var _ensoft$entrance$EnTrance_Notification$WarningNfn = function (a) {
	return {ctor: 'WarningNfn', _0: a};
};
var _ensoft$entrance$EnTrance_Notification$ErrorNfn = function (a) {
	return {ctor: 'ErrorNfn', _0: a};
};
var _ensoft$entrance$EnTrance_Notification$PongNfn = {ctor: 'PongNfn'};
var _ensoft$entrance$EnTrance_Notification$WebSocketUpNfn = {ctor: 'WebSocketUpNfn'};
var _ensoft$entrance$EnTrance_Notification$globalNfnDecoder = function (nfnType) {
	var _p0 = nfnType;
	switch (_p0) {
		case 'websocket_up':
			return _elm_lang$core$Json_Decode$succeed(_ensoft$entrance$EnTrance_Notification$WebSocketUpNfn);
		case 'pong':
			return _elm_lang$core$Json_Decode$succeed(_ensoft$entrance$EnTrance_Notification$PongNfn);
		case 'error':
			return A2(
				_elm_lang$core$Json_Decode$map,
				_ensoft$entrance$EnTrance_Notification$ErrorNfn,
				A2(_elm_lang$core$Json_Decode$field, 'value', _elm_lang$core$Json_Decode$string));
		default:
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'Unknown global nfn_type: ', _p0));
	}
};
var _ensoft$entrance$EnTrance_Notification$nfnEndpointDecoder = F3(
	function (cfg, model, _p1) {
		var _p2 = _p1;
		var _p5 = _p2._1;
		var _p4 = _p2._0;
		if (_elm_lang$core$Native_Utils.eq(_p4, _ensoft$entrance$EnTrance_Internal$globalEndpointName)) {
			return A2(
				_elm_lang$core$Json_Decode$map,
				cfg.makeGlobal,
				_ensoft$entrance$EnTrance_Notification$globalNfnDecoder(_p5));
		} else {
			var _p3 = A2(_elm_lang$core$Dict$get, _p4, cfg.endpoints);
			if (_p3.ctor === 'Just') {
				return A2(_p3._0, _p5, model);
			} else {
				return _elm_lang$core$Json_Decode$fail(
					A2(_elm_lang$core$Basics_ops['++'], 'Unknown endpoint: ', _p4));
			}
		}
	});
var _ensoft$entrance$EnTrance_Notification$nfnDecoder = F2(
	function (cfg, model) {
		return A2(
			_elm_lang$core$Json_Decode$andThen,
			A2(_ensoft$entrance$EnTrance_Notification$nfnEndpointDecoder, cfg, model),
			A3(
				_elm_lang$core$Json_Decode$map2,
				F2(
					function (v0, v1) {
				...
				A2(_elm_lang$core$Json_Decode$field, 'nfn_type', _elm_lang$core$Json_Decode$string)));
	});
var _ensoft$entrance$EnTrance_Notification$decode = F3(
	function (cfg, model, json) {
		var _p6 = A2(
			_elm_lang$core$Json_Decode$decodeString,
			A2(_ensoft$entrance$EnTrance_Notification$nfnDecoder, cfg, model),
			json);
		if (_p6.ctor === 'Ok') {
			return _p6._0;
		} else {
			var _p8 = _p6._0;
			return _ensoft$entrance$EnTrance_Internal$errorIsWarning(_p8) ? cfg.makeGlobal(
				_ensoft$entrance$EnTrance_Notification$WarningNfn(_p8)) : function (_p7) {
				return cfg.makeGlobal(
					_ensoft$entrance$EnTrance_Notification$ErrorNfn(_p7));
			}(
				A2(
					_elm_lang$core$Basics_ops['++'],
					'Invalid JSON: ',
...
var _ensoft$entrance$EnTrance_Persist$decode = function (decoder) {
	return A2(_elm_lang$core$Json_Decode$field, 'data', decoder);
};
var _ensoft$entrance$EnTrance_Persist$load = function (defaultData) {
	return A3(
		_ensoft$entrance$EnTrance_Endpoint$addValue,
		'default',
		defaultData,
		_ensoft$entrance$EnTrance_Endpoint$request('persist_load'));
};
var _ensoft$entrance$EnTrance_Persist$save = function (data) {
	return A3(
		_ensoft$entrance$EnTrance_Endpoint$addValue,
		'data',
		data,
		_ensoft$entrance$EnTrance_Endpoint$request('persist_save'));
};

var _ensoft$entrance$EnTrance_Ping$pure = function (state) {
	return {ctor: '_Tuple2', _0: state, _1: _elm_lang$core$Platform_Cmd$none};
};
var _ensoft$entrance$EnTrance_Ping$sendPing = function (endpoint) {
	return A2(
		_ensoft$entrance$EnTrance_Endpoint$sendRaw,
		endpoint,
		_ensoft$entrance$EnTrance_Endpoint$request('ping'));
};
var _ensoft$entrance$EnTrance_Ping$pongNotification = function (state) {
	return _elm_lang$core$Native_Utils.update(
		state,
		{lastPingReceivedAt: state.lastTick});
};
var _ensoft$entrance$EnTrance_Ping$websocketUp = function (state) {
	return _ensoft$entrance$EnTrance_Ping$pure(
		_elm_lang$core$Native_Utils.update(
			state,
			{connectionStarted: true}));
};
var _ensoft$entrance$EnTrance_Ping$timeout = 3 * _elm_lang$core$Time$second;
var _ensoft$entrance$EnTrance_Ping$update = F2(
	function (msg, state) {
		var _p0 = msg;
		if (_p0.ctor === 'Tick') {
			var _p1 = _p0._0;
			var cmd = state.connectionStarted ? _ensoft$entrance$EnTrance_Ping$sendPing(state.endpoint) : _elm_lang$core$Platform_Cmd$none;
			var lastPingReceivedAt = _elm_lang$core$Native_Utils.eq(state.lastPingReceivedAt, 0) ? _p1 : state.lastPingReceivedAt;
			var displayWarning = (_elm_lang$core$Native_Utils.cmp(_p1 - lastPingReceivedAt, _ensoft$entrance$EnTrance_Ping$timeout) > 0) && (!state.stopMonitoring);
			return {
				ctor: '_Tuple2',
				_0: _elm_lang$core$Native_Utils.update(
					state,
					{lastTick: _p1, lastPingReceivedAt: lastPingReceivedAt, displayWarning: displayWarning}),
				_1: cmd
			};
		} else {
			return _ensoft$entrance$EnTrance_Ping$pure(
				_elm_lang$core$Native_Utils.update(
					state,
					{stopMonitoring: true, displayWarning: false}));
		}
	});
var _ensoft$entrance$EnTrance_Ping$displayWarning = function (_) {
	return _.displayWarning;
};
var _ensoft$entrance$EnTrance_Ping$State = F6(
	function (a, b, c, d, e, f) {
		return {connectionStarted: a, stopMonitoring: b, lastTick: c, lastPingReceivedAt: d, displayWarning: e, endpoint: f};
	});
var _ensoft$entrance$EnTrance_Ping$init = function (websocket) {
	return A6(
		_ensoft$entrance$EnTrance_Ping$State,
		false,
		false,
		0,
		0,
		false,
		A2(_ensoft$entrance$EnTrance_Endpoint$named, _ensoft$entrance$EnTrance_Internal$globalEndpointName, websocket));
};
var _ensoft$entrance$EnTrance_Ping$StopMonitoring = {ctor: 'StopMonitoring'};
var _ensoft$entrance$EnTrance_Ping$Tick = function (a) {
	return {ctor: 'Tick', _0: a};
};
var _ensoft$entrance$EnTrance_Ping$subscriptions = function (state) {
	return state.stopMonitoring ? _elm_lang$core$Platform_Sub$none : A2(_elm_lang$core$Time$every, _elm_lang$core$Time$second, _ensoft$entrance$EnTrance_Ping$Tick);
};

var _ensoft$entrance_examples$Types$Model = F6(
	function (a, b, c, d, e, f) {
		return {editText: a, notes: b, errors: c, connected: d, pingState: e, endpoint: f};
	});
var _ensoft$entrance_examples$Types$Flags = function (a) {
	return {websocket: a};
};
var _ensoft$entrance_examples$Types$PingMsg = function (a) {
	return {ctor: 'PingMsg', _0: a};
};
var _ensoft$entrance_examples$Types$ReceivedJSON = function (a) {
	return {ctor: 'ReceivedJSON', _0: a};
};
var _ensoft$entrance_examples$Types$ClearAll = {ctor: 'ClearAll'};
var _ensoft$entrance_examples$Types$Save = {ctor: 'Save'};
var _ensoft$entrance_examples$Types$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _ensoft$entrance_examples$Types$GlobalNfn = function (a) {
	return {ctor: 'GlobalNfn', _0: a};
};
var _ensoft$entrance_examples$Types$Load = function (a) {
...
var _ensoft$entrance_examples$State$mapPing = function (model) {
	return A2(
...
var _ensoft$entrance_examples$State$andThen = F2(
	function (update, _p0) {
		var _p1 = _p0;
...
var _ensoft$entrance_examples$State$pure = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _ensoft$entrance_examples$State$nfnDecoder = F2(
	function (nfnType, _p3) {
		var _p4 = nfnType;
		if (_p4 === 'persist_load') {
			return A2(
				_elm_lang$core$Json_Decode$map,
				_ensoft$entrance_examples$Types$Load,
				_ensoft$entrance$EnTrance_Persist$decode(
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
		} else {
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'Unknown nfn_type: ', _p4));
		}
	});
var _ensoft$entrance_examples$State$cfg = A2(
	_ensoft$entrance$EnTrance_Notification$Config,
	_ensoft$entrance_examples$Types$GlobalNfn,
	_elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _ensoft$entrance$EnTrance_Endpoint$defaultEndpoint, _1: _ensoft$entrance_examples$State$nfnDecoder},
			_1: {ctor: '[]'}
		}));
var _ensoft$entrance_examples$State$websocketUp = function (model) {
	var startPinging = function (m) {
		return A2(
			_ensoft$entrance_examples$State$mapPing,
			m,
			_ensoft$entrance$EnTrance_Ping$websocketUp(model.pingState));
	};
	var loadNotes = F2(
		function (m, defaultValue) {
			return A2(
				_ensoft$entrance$EnTrance_Endpoint$send,
				m,
				_ensoft$entrance$EnTrance_Persist$load(
					_elm_lang$core$Json_Encode$list(defaultValue)));
		});
	return A2(
		_ensoft$entrance_examples$State$andThen,
		startPinging,
		A2(
			loadNotes,
			model,
...
var _ensoft$entrance_examples$State$nfnUpdate = F2(
	function (notification, model) {
		var _p5 = notification;
		if (_p5.ctor === 'Load') {
			return _ensoft$entrance_examples$State$pure(
				_elm_lang$core$Native_Utils.update(
					model,
					{notes: _p5._0, connected: true}));
		} else {
			var _p6 = _p5._0;
			switch (_p6.ctor) {
				case 'WebSocketUpNfn':
					return _ensoft$entrance_examples$State$websocketUp(model);
				case 'ErrorNfn':
					return _ensoft$entrance_examples$State$pure(
						_elm_lang$core$Native_Utils.update(
							model,
				...
				default:
					return _ensoft$entrance_examples$State$pure(
						_elm_lang$core$Native_Utils.update(
							model,
							{
								pingState: _ensoft$entrance$EnTrance_Ping$pongNotification(model.pingState)
							}));
			}
		}
	});
var _ensoft$entrance_examples$State$update = F2(
	function (msg, model) {
		var updateNotes = function (newNotes) {
			return A2(
				...
				_elm_lang$core$Native_Utils.update(
					model,
					{notes: newNotes, editText: ''}),
				_ensoft$entrance$EnTrance_Persist$save(
					_elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, newNotes))));
		};
		var _p7 = msg;
		switch (_p7.ctor) {
			case 'Input':
			...
			case 'Save':
				return updateNotes(
					{ctor: '::', _0: model.editText, _1: model.notes});
			case 'ClearAll':
				return updateNotes(
					{ctor: '[]'});
			case 'ReceivedJSON':
				return A2(
					_ensoft$entrance_examples$State$nfnUpdate,
					A3(_ensoft$entrance$EnTrance_Notification$decode, _ensoft$entrance_examples$State$cfg, model, _p7._0),
					model);
			default:
				return A2(
					_ensoft$entrance_examples$State$mapPing,
					model,
					A2(_ensoft$entrance$EnTrance_Ping$update, _p7._0, model.pingState));
		}
	});
...
var _ensoft$entrance_examples$State$initialModel = function (flags) {
	return _ensoft$entrance_examples$State$pure(
		{
			editText: '',
			notes: {ctor: '[]'},
			errors: {ctor: '[]'},
			connected: false,
			pingState: _ensoft$entrance$EnTrance_Ping$init(flags.websocket),
			endpoint: _ensoft$entrance$EnTrance_Endpoint$default(flags.websocket)
		});
};
...
var _ensoft$entrance_examples$View$pingModal = function (pingState) {
	var abortMsg = _ensoft$entrance_examples$Types$PingMsg(_ensoft$entrance$EnTrance_Ping$StopMonitoring);
	var visibility = _ensoft$entrance$EnTrance_Ping$displayWarning(pingState) ? _rundis$elm_bootstrap$Bootstrap_Modal$shown : _rundis$elm_bootstrap$Bootstrap_Modal$hidden;
	var messages = {
		ctor: '::',
		_0: 'The server is unresponsive or network connectivity is lost.',
		_1: {
			ctor: '::',
			_0: 'I\'m afraid the app cannot function correctly until this is restored.',
			_1: {
				ctor: '::',
				_0: 'This message will disappear automatically once the situation is rectified.',
				_1: {ctor: '[]'}
			}
		}
	};
		...
		A3(
			...
			{ctor: '[]'},
			{
				...
				_0: A2(
					_rundis$elm_bootstrap$Bootstrap_Button$button,
					{
						...
						_1: {
							...
							_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onClick(abortMsg),
									_1: {ctor: '[]'}
								}),
							_1: {ctor: '[]'}
						}
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('I don\'t care'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			},
			A3(
				...
				A3(
					...
					_rundis$elm_bootstrap$Bootstrap_Modal$large(
						_rundis$elm_bootstrap$Bootstrap_Modal$config(abortMsg))))));
};
var _ensoft$entrance_examples$View$listOf = F2(
	function (elem, items) {
		return A2(
			_elm_lang$core$List$map,
			function (x) {
...
var _ensoft$entrance_examples$View$viewInput = F2(
	function (editText, connected) {
		return A2(
			_elm_lang$html$Html$div,
			{ctor: '[]'},
			{
								...
								_rundis$elm_bootstrap$Bootstrap_Form_InputGroup$button,
								{
									...
									_1: {
										...
										_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_ensoft$entrance_examples$Types$Save),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
											_0: _rundis$elm_bootstrap$Bootstrap_Button$disabled(!connected),
											_1: {ctor: '[]'}
										}
									}
								},
									...
									_rundis$elm_bootstrap$Bootstrap_Form_InputGroup$button,
									{
										...
										_1: {
											...
											_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_ensoft$entrance_examples$Types$ClearAll),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
							...
							_rundis$elm_bootstrap$Bootstrap_Form_InputGroup$text(
								{
									...
									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$value(editText),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$autofocus(true),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_ensoft$entrance_examples$Types$Input),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Attributes$placeholder('Enter new note here'),
														_1: {ctor: '[]'}
													}
												}
											}
...
var _ensoft$entrance_examples$View$view = function (model) {
	return A2(
		_rundis$elm_bootstrap$Bootstrap_Grid$container,
		{ctor: '[]'},
		{
			ctor: '::',
			_0: _ensoft$entrance_examples$View$pingModal(model.pingState),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$class('my-3'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('EnTrance demo notes app'),
						_1: {ctor: '[]'}
					}),
				_1: {
					ctor: '::',
					_0: A2(_ensoft$entrance_examples$View$viewInput, model.editText, model.connected),
					_1: {
						ctor: '::',
						_0: A2(
							_elm_lang$html$Html$div,
							{ctor: '[]'},
							A2(_ensoft$entrance_examples$View$listOf, _rundis$elm_bootstrap$Bootstrap_Alert$simpleDanger, model.errors)),
						_1: {
							ctor: '::',
							_0: A2(
								...
								A2(_ensoft$entrance_examples$View$listOf, _elm_lang$html$Html$li, model.notes)),
							_1: {ctor: '[]'}
						}
					}
				}
...
var _ensoft$entrance_examples$Main$main = _elm_lang$html$Html$programWithFlags(
	{init: _ensoft$entrance_examples$State$initialModel, view: _ensoft$entrance_examples$View$view, update: _ensoft$entrance_examples$State$update, subscriptions: _ensoft$entrance_examples$State$subscriptions})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (websocket) {
			return _elm_lang$core$Json_Decode$succeed(
		...
		A2(_elm_lang$core$Json_Decode$field, 'websocket', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _ensoft$entrance_examples$Main$main !== 'undefined') {
    _ensoft$entrance_examples$Main$main(Elm['Main'], 'Main', undefined);
}

...
var _ensoft$entrance_examples$Main$pure = function (model) {
	return {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none};
};
var _ensoft$entrance_examples$Main$listOf = F2(
	function (elem, items) {
		return A2(
			_elm_lang$core$List$map,
			function (x) {
...
var _ensoft$entrance_examples$Main$nfnUpdate = F2(
...
var _ensoft$entrance_examples$Main$initialModel = function (websocket) {
	return _ensoft$entrance_examples$Main$pure(
		{
			editText: '',
			notes: {ctor: '[]'},
			errors: {ctor: '[]'},
			connected: false,
			endpoint: _ensoft$entrance$EnTrance_Endpoint$default(websocket)
		});
};
var _ensoft$entrance_examples$Main$Model = F5(
	function (a, b, c, d, e) {
		return {editText: a, notes: b, errors: c, connected: d, endpoint: e};
	});
var _ensoft$entrance_examples$Main$ReceivedJSON = function (a) {
	return {ctor: 'ReceivedJSON', _0: a};
};
var _ensoft$entrance_examples$Main$subscriptions = function (model) {
	return A2(
		_ensoft$entrance$EnTrance_Notification$subscription,
		_ensoft$entrance_examples$Main$ReceivedJSON,
		_ensoft$entrance$EnTrance_Endpoint$getWebSocket(model.endpoint));
};
var _ensoft$entrance_examples$Main$ClearAll = {ctor: 'ClearAll'};
var _ensoft$entrance_examples$Main$Save = {ctor: 'Save'};
var _ensoft$entrance_examples$Main$Input = function (a) {
	return {ctor: 'Input', _0: a};
};
var _ensoft$entrance_examples$Main$viewInput = F2(
								...
								_rundis$elm_bootstrap$Bootstrap_Form_InputGroup$button,
								{
									...
									_1: {
										...
										_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
											{
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(_ensoft$entrance_examples$Main$Save),
												_1: {ctor: '[]'}
											}),
										_1: {
											ctor: '::',
									...
									_rundis$elm_bootstrap$Bootstrap_Form_InputGroup$button,
									{
										...
										_1: {
											...
											_0: _rundis$elm_bootstrap$Bootstrap_Button$attrs(
												{
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(_ensoft$entrance_examples$Main$ClearAll),
													_1: {ctor: '[]'}
												}),
											_1: {
												ctor: '::',
									...
									_0: _rundis$elm_bootstrap$Bootstrap_Form_Input$attrs(
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onInput(_ensoft$entrance_examples$Main$Input),
													_1: {
														ctor: '::',
...
var _ensoft$entrance_examples$Main$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: A2(_ensoft$entrance_examples$Main$viewInput, model.editText, model.connected),
				_1: {
					ctor: '::',
					_0: A2(
						_elm_lang$html$Html$div,
						{ctor: '[]'},
						A2(_ensoft$entrance_examples$Main$listOf, _rundis$elm_bootstrap$Bootstrap_Alert$simpleDanger, model.errors)),
					_1: {
						ctor: '::',
						_0: A2(
							...
							A2(_ensoft$entrance_examples$Main$listOf, _elm_lang$html$Html$li, model.notes)),
						_1: {ctor: '[]'}
					}
				}
			}
...
var _ensoft$entrance_examples$Main$GlobalNfn = function (a) {
	return {ctor: 'GlobalNfn', _0: a};
};
var _ensoft$entrance_examples$Main$Load = function (a) {
	return {ctor: 'Load', _0: a};
};
var _ensoft$entrance_examples$Main$nfnDecoder = F2(
	function (nfnType, model) {
		var _p3 = nfnType;
		if (_p3 === 'persist_load') {
			return A2(
				_elm_lang$core$Json_Decode$map,
				_ensoft$entrance_examples$Main$Load,
				_ensoft$entrance$EnTrance_Persist$decode(
					_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$string)));
		} else {
			return _elm_lang$core$Json_Decode$fail(
				A2(_elm_lang$core$Basics_ops['++'], 'Unknown nfn_type: ', _p3));
		}
	});
var _ensoft$entrance_examples$Main$cfg = A2(
	_ensoft$entrance$EnTrance_Notification$Config,
	_ensoft$entrance_examples$Main$GlobalNfn,
	_elm_lang$core$Dict$fromList(
		{
			ctor: '::',
			_0: {ctor: '_Tuple2', _0: _ensoft$entrance$EnTrance_Endpoint$defaultEndpoint, _1: _ensoft$entrance_examples$Main$nfnDecoder},
			_1: {ctor: '[]'}
		}));
var _ensoft$entrance_examples$Main$update = F2(
	function (msg, model) {
		...
		switch (_p4.ctor) {
			...
			default:
				return A2(
					_ensoft$entrance_examples$Main$nfnUpdate,
					A3(_ensoft$entrance$EnTrance_Notification$decode, _ensoft$entrance_examples$Main$cfg, model, _p4._0),
					model);
		}
	});
var _ensoft$entrance_examples$Main$main = _elm_lang$html$Html$programWithFlags(
	{
		init: function (_p5) {
			return _ensoft$entrance_examples$Main$initialModel(
				function (_) {
					return _.websocket;
				}(_p5));
		},
		view: _ensoft$entrance_examples$Main$view,
		update: _ensoft$entrance_examples$Main$update,
		subscriptions: _ensoft$entrance_examples$Main$subscriptions
	})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
		function (websocket) {
